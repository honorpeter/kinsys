...
#   ]
#
# set_property -dict [list CONFIG.C_DATA_DEPTH {4096} CONFIG.C_NUM_OF_PROBES {11} CONFIG.C_MON_TYPE {MIX} CONFIG.C_BRAM_CNT {24.5} CONFIG.C_INPUT_PIPE_STAGES {2}] [get_bd_cells system_ila]
